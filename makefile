...
bin/main_client.o: src/main_client.cpp  
	C:\Qt\Tools\mingw1120_64\bin\g++.exe -c src/main_client.cpp -lpthread -lminiupnpc -fpermissive -O3 -lstdc++fs -L /lib -I /include -lmingw32  -D_WIN32_WINNT=0x0601 -lws2_32 -lwsock32 -o bin/main_client.o

bin/main_server.o: src/main_server.cpp  
	C:\Qt\Tools\mingw1120_64\bin\g++.exe -c src/main_server.cpp -lpthread -lminiupnpc -fpermissive -O3 -lstdc++fs -L /lib -I /include -lmingw32  -D_WIN32_WINNT=0x0601 -lws2_32 -lwsock32 -o bin/main_server.o
